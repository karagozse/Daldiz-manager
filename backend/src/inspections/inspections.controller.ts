...
export class InspectionsController {
  ...
  @Get()
  findAll(@Query('gardenId') gardenId?: string) {
    if (gardenId) {
      return this.inspectionsService.findByGardenId(Number(gardenId));
    }
  ...
  delete(
    ...
    return this.inspectionsService.delete(id, user.id, user.role);
  }
}
